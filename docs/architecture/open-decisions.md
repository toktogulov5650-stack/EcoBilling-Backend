...
| Платежи | Провайдер, ProviderReference, callback и подпись, статусы, частичная оплата, распределение, переплата, отмена и возвраты | До регистрации через провайдера и изменения финансового состояния |
