...
namespace EcoBilling.Infrastructure.Migrations
{
    ...
    [Migration("20260926114854_AddDirectorProvisioning")]
    partial class AddDirectorProvisioning
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoBilling.Modules.Identity.Domain.DirectorProfile", b =>
                {
                    ...
                    b.ToTable("directors", "identity", t =>
                        {
                            t.HasCheckConstraint("ck_directors_instance_slot", "instance_slot = 1");
                        });
                });

            modelBuilder.Entity("EcoBilling.Modules.Identity.Domain.DirectorProvisioningOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("EcoBilling.Modules.Identity.Domain.DirectorProfile", b =>
                {
                    b.HasOne("EcoBilling.Modules.Identity.Domain.UserAccount", null)
                        .WithOne()
                        .HasForeignKey("EcoBilling.Modules.Identity.Domain.DirectorProfile", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
            ...
            modelBuilder.Entity("EcoBilling.Modules.Identity.Domain.DirectorProvisioningOperation", b =>
                {
                    b.HasOne("EcoBilling.Modules.Identity.Domain.DirectorProfile", null)
                        .WithMany()
